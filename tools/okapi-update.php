...
require_once 'okapi-update-settings.inc.php';
...
passthru(
    str_replace(
        ...
        str_replace('%dest', OCDE_ROOTPATH . '/okapi', DIRECTORY_TREE_REPLICATOR)
    )
);
$core = file_get_contents(OCDE_ROOTPATH . '/okapi/core/Okapi.php');
$core = str_replace(
    "\$version_number = null",
...
file_put_contents(OCDE_ROOTPATH . '/okapi/core/Okapi.php', $core);
chdir(OCDE_ROOTPATH);
passthru('git status');
