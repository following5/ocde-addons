 ...
 * This includes also doctrine migrations, which are missing in dbupdate.php
 * in the OC repo.
 */
...
require '../bin/dbsv-update.php';
system('bin/console doctrine:migrations:migrate -n|sed "/^\s*$/d"|sed "/Application Migrations/d"');
...
system('wget -O translations.zip "https://www.opencaching.de/translations.zip"');
system('unzip -o translations.zip');
system('rm translations.zip');
foreach(['de', 'el', 'en', 'es', 'fr', 'it', 'nl', 'pl', 'ru'] as $lang)
    system("bin/console translation:update $lang --force");
system('bin/console translation:import-legacy-translation');
*/
