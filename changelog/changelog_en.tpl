...
<div class="content-txtbox-noshade changelog" style="padding-right: 25px;">
    ...
    <ul>
        ...
        <li><a href="https://www.opencaching.de/doc/xml">XML interface fixes</a>. If you were using the replication feature of version 1.4, you should import a complete dump.</li>
    </ul>
    <br />

    <div class="changelog-header">
        <p id="v3.0.17"><strong>OC3 Release 17</strong> <span class="version">(3.0.17)</span> &ndash; 7 March 2016</p>
    </div>
    ...
    <div class="changelog-header">
        <p id="v3.0.16"><strong>OC3 Release 16</strong> <span class="version">(3.0.16)</span> &ndash; 1 February 2016</p>
    </div>

    <p>New:</p>
    <ul>
        <li>The <a href="https://www.opencaching.de/search.php">cache search</a> results can be sorted by clicking on the table headers.</li>
        <li>When chosing search result order by hide date, this date is displayed in the results list.</li>
        <li>Added statistics by log type to the <a href="https://www.opencaching.de/ownerlogs.php">log statistics for own caches</a>.</li>
        <li>Old late logs can be hidden in the <a href="https://www.opencaching.de/newlogs.php">list of new logs</a>; list now is sortable by either log date or log submit date.</li>
        <li>OConly marks (<img src="https://www.opencaching.de/resource2/ocstyle/images/misc/15x15-oc.png">) are shown in the lists of new logs and of own logs.</li>
    ...
    <ul>
        ...
        <li>Show the correct symbol for cache listings which have been locked/hidden by the Opencaching team (<img src="https://www.opencaching.de/resource2/ocstyle/images/cachestatus/16x16-locked-invisible.png">) [bug of release 6]</li>
    ...
    <div class="changelog-header">
        <p id="v3.0.15"><strong>OC3 Release 15</strong> <span class="version">(3.0.15)</span> &ndash; 19 September 2015</p>
    </div>
    <p>New:</p>
    <ul>
    ...
    <div class="changelog-header">
        <p id="v3.0.14"><strong>OC3 Release 14</strong> <span class="version">(3.0.14)</span> &ndash; 5 September 2015</p>
    </div>
    ...
    <ul>
        ...
        <li>Improved the English translation (
    ...
    <p>New:</p>
    <ul>
        <li><a href="https://www.opencaching.de/cachelists.php">Cache lists</a></li>
    ...
    <div class="changelog-header">
        <p id="v3.0.12"><strong>OC3 Release 12</strong> <span class="version">(3.0.12)</span> &ndash; 31 May 2015</p>
    </div>
    ...
    <ul>
        ...
        <li>new <a href="https://www.opencaching.de/myprofile.php">user profile setting</a> to include the own e-mail address by default when writing to other users</li>
        <li><a href="https://www.opencaching.de/okapi">OKAPI</a>: added experimental support for the new Garmin GGZ data format</li>
    </ul>
    ...
    <div class="changelog-header">
        <p id="v3.0.11"><strong>OC3 Release 11</strong> <span class="version">(3.0.11)</span> &ndash; 21 June 2014</p>
    </div>
    ...
    <div class="changelog-header">
        <p id="v3.0.10"><strong>OC3 Release 10</strong> <span class="version">(3.0.10)</span> &ndash; 24 August 2013</p>
    </div>
    ...
    <ul>
        ...
        <li>explained cache sizes on the <a href="https://www.opencaching.de/articles.php?page=cacheinfo">description</a> page</li>
    </ul>
    ...
    <div class="changelog-header">
        <p id="v3.0.9"><strong>OC3 Release 9</strong> <span class="version">(3.0.9)</span> &ndash; 25 July 2013</p>
    </div>

    <p>Reworked <a href="https://www.opencaching.de/search.php">searching for geocaches</a>:</p>
    <ul>
    ...
    <p>Improved <a href="https://www.opencaching.de/myhome.php#mycaches">lists of own geocaches</a>:</p>
    <ul>
        ...
        <li><a href="https://www.opencaching.de/ownerlogs.php">New logs list</a> for all own caches</li>
    </ul>

    <p>More new features:</p>
    <ul>
        <li>recommendations are marked with <img src="https://www.opencaching.de/images/rating-star.gif" /> in log lists</li>
        <li>OConly caches are marked with <img src="https://www.opencaching.de/resource2/ocstyle/images/misc/15x15-oc.png" /> in cache lists</li>
        <li>OConly tag in new cache notifications; notifications about newly tagged OConlies can be enabled in user profile</li>
        <li>information on protection areas in GPX, OKAPI and <a href="https://www.opencaching.de/doc/xml">XML Interface</a> downloads</li>
    ...
    <ul>
        ...
        <li>sort <a href="https://www.opencaching.de/mytop5.php">own recommendations</a> by date</li>
    ...
    <ul>
        ...
        <li>fixed transfering OC user names into <a href="https://www.opencaching.de/webchat.php">chat</a> window</li>
    ...
    <div class="changelog-header">
        <p id="v3.0.8"><strong>OC3 Release 8</strong> <span class="version">(3.0.8)</span> &ndash; 1 June 2013</p>
    </div>
    ...
    <ul>
        ...
        <li>OC support team members can mark thir logs as "OC team log" (<img src="https://www.opencaching.de/resource2/ocstyle/images/oclogo/oc-team-comment.png" />)</li>
        <li>added additional waypoints, log time, OC team log flag and preview picture flag to the "XML interface"</li>
        <li>additional user profile menu option <a href="https://www.opencaching.de/okapi/apps/">API applications</a>, to control <a href="https://www.opencaching.de/okapi">OKAPI</a> app access rights</li>
        ...
        <li>new <a href="https://www.opencaching.de/404.php">error page</a> fÃ¼r for invalid page requests</li>
    </ul>
    ...
    <ul>
        ...
        <li>intergrated chat directly into the OC website</li>
        ...
        <li>added recommendation date to <a href="https://www.opencaching.de/mytop5.php">personal recommendation list</a></li>
        ...
        <li>updated <a href="https://www.opencaching.de/articles.php?page=verein">Opencaching Deutschland e.V.</a> page and membership application form (German)</li>
    </ul>

    <p>Fixed:</p>
    <ul>
        <li>event log icons (<img src="https://www.opencaching.de/resource2/ocstyle/images/log/16x16-will_attend.png" /> <img src="https://www.opencaching.de/resource2/ocstyle/images/log/16x16-attended.png" />) in search result lists</li>
    ...
    <div class="changelog-header">
        <p id="v3.0.7"><strong>OC3 Release 7</strong> <span class="version">(3.0.7)</span> &ndash; 19 April 2013</p>
    </div>

    <ul>
        <li>New: <a href="https://www.opencaching.de/okapi">OKAPI</a></li>
    ...
    <div class="changelog-header">
        <p id="v3.0.6"><strong>OC3 Release 6</strong> <span class="version">(3.0.6)</span> &ndash; 12 April 2013</p>
    </div>
    ...
    <div class="changelog-header">
        <p id="v3.0.5"><strong>OC3 Release 5</strong> <span class="version">(3.0.5)</span> &ndash; 16 March 2013</p>
    </div>
    ...
    <ul>
        ...
        <li><a href="https://www.opencaching.de/map2.php?mode=fullscreen">Full screen map</a> with swing-out filter options</li>
        ...
        <li>home button jumps to the home coordinates given in your <a href="https://www.opencaching.de/myprofile.php">user profile</a></li>
        <li>Cache selection / filtering improvements:
            <ul>
                <li>easier selection of single cache types and sizes</li>
                <li>preselection of the most relevant attributes like at the <a href="https://www.opencaching.de/search.php">search pache</a></li>
    ...
    <ul>
        <li>Log picture galleries on the start page, the new <a href="https://www.opencaching.de/newlogpics.php">gallery page</a>, in cache listings (via link "log pictures") and in user profiles. The profile galleries can be disabled via <a href="https://www.opencaching.de/mydetails.php">profile settings.</a></li>
        ...
        <li>Inactive caches are <s>striked out</s> in the <a href="https://www.opencaching.de/mywatches.php">watch list</a> like in the ignore list.</li>
    ...
    <div class="changelog-header">
        <p id="v3.0.4"><strong>OC3 Release 4</strong> <span class="version">(3.0.4)</span> &ndash; 17 February 2013
    </div>
    ...
    <ul>
        ...
        <li><a href="https://www.opencaching.de/articles.php?page=impressum#datalicense">data license CC-BY-NC-ND</a></li>
    ...
    <ul>
        ...
        <li>The <a href="https://www.opencaching.de/map2.php">map</a> will now show up to 600 instead of 180 cache symbols (MS Internet Explorer: up to 200).</a></li>
        <li>consistend display of <a href="https://www.opencaching.de/newlogs.php">new logs list</a></li>
        ...
        <li>updated <a href="https://www.opencaching.de/articles.php?page=team">team</a> and <a href="https://www.opencaching.de/articles.php?page=donations">donations</a> page</a></li>
        <li>updated <a href="https://www.opencaching.de/articles.php?page=dsb">privacy statement</a> and improved data privacy</li>
    ...
    <ul>
        ...
        <li>icons for event logs in <a href="https://www.opencaching.de/newlogs.php">new logs list</a></li>
    </ul>
    <br />

    <div class="changelog-header">
        <p id="v3.0.3"><strong>OC3 Release 3</strong> <span class="version">(3.0.3)</span> &ndash; 18 November 2012</p>
    </div>
    ...
    <ul>
        ...
        <li>updated <a href="https://www.opencaching.de/articles.php?page=team">team members list</a></li>
    ...
    <div class="changelog-header">
        <p id="v3.0.2"><strong>OC3 Release 2</strong> <span class="version">(3.0.2)</span> &ndash; 26 August 2012</p>
    </div>

    <p>New:</p>
    <ul>
       <li><a href="https://www.opencaching.de/articles.php?page=cacheinfo#difficulty">Difficulty ratings</a> explained, including tooltips and links within the cache listings</li>
       <li><a href="https://www.opencaching.de/articles.php?page=verein">Vereinsseite</a> (currently German only)
    </ul>
    
    <p>Changed / improved:</p>
    <ul>
        <li>improved <a href="https://www.opencaching.de/index.php">Homepag</a> performance</li>
        <li>rewritten <a href="https://www.opencaching.de/articles.php?page=cacheinfo">cache description</a> info</li>
        <li>updated <a href="https://www.opencaching.de/doc/xml/">XML Interface Documentation</a> (German) and <a href="https://github.com/OpencachingDeutschland/oc-server3/blob/master/doc/license.txt">Source code license</a></li>
        <li>updated <a href="https://www.opencaching.de/articles.php?page=team">Team members list</a></li>
        <li>announced new <a href="https://www.opencaching.de/articles.php?page=donations">bank account</a> for donations</li>
        ...
        <li>hidden inaktive new caches on <a href="https://www.opencaching.de/newcachesrest.php">All-but-Germany</a> page</li>
    ...
    <ul>
        ...
        <li><a href="https://www.opencaching.de/doc/xml/">XML-Interface</a> will not truncate default charset data at unknown characters.</li>
    ...
    <div class="changelog-header">
        <p id="v3.0.1"><strong>OC3 Release 1</strong> <span class="version">(3.0.2)</span> &ndash; 8 August 2012</p>
    </div>
    ...
    <ul>
        ...
        <li>englisch translation of <a href="https://www.opencaching.de/articles.php?page=geocaching">About Geocaching</a>, <a href="https://www.opencaching.de/articles.php?page=cacheinfo">Cache descriptions</a>, <a href="https://www.opencaching.de/articles.php?page=impressum">Legal information</a>, <a href="https://www.opencaching.de/articles.php?page=dsb">Privacy statement</a>, <a href="https://www.opencaching.de//articles.php?page=donations">Donations</a>, <a href="https://www.opencaching.de/articles.php?page=contact">Contact</a> and <a href="https://www.opencaching.de/articles.php?page=team">Team members' list</a> pages; team list, legal information and donations pages have been updated</li>
    ...
    <ul>
        ...
        <li>new <a href="https://www.opencaching.de/articles.php?page=team">list of team members</a></li>
        <li>display of new caches at <a href="https://www.opencaching.de/index.php">start page</a> by publishing instead of hiding date, and at <a href="https://www.opencaching.de/newcaches.php">New caches</a> page by publishing instead of listing creation date</li>
        ...
        <li>layout adjustment of <a href="https://www.opencaching.de/search.php">search page</a> and <a href="http://www.blog.opencaching.de">blog/info page</a></li>
    ...
    <ul>
        ...
        <li>display of cache type icon for unpublished caches at <a href="https://www.opencaching.de/myhome.php">user profile</a> &rarr; Show all</li>
